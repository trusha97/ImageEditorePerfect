// Shared language configuration used across the app
// Import this in Header.js, data.js, and other files that need language info
...
export const getLanguageByCode = (code) => {
  ...
  return languages.find(l => l.code === code.toLowerCase()) || languages[0];
};

// Helper: Check if a code is a valid language
