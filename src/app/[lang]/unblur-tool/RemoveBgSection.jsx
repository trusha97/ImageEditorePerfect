...
const RemoveBgSection = () => {
  ...
  return (
    <div>
      <div className="max-w-[1398px] mx-auto flex flex-col items-center justify-center px-6 py-10 rounded-t-[30px]" style={{
        background: "background: linear-gradient(180deg, rgba(220, 234, 255, 0.5) 0%, rgba(220, 234, 255, 0) 100%)"
      }}>
        <div className="flex">
          <div>
            {/* Header Section */}
          ...
          <div>
            <div className="mt-10 flex flex-col items-center">
              <div className="relative w-[280px] h-[280px] md:w-[400px] md:h-[400px] rounded-lg overflow-hidden border shadow-md">
                ...
                />
               <div className="absolute top-0 right-0 w-1/2 h-full  bg-cover bg-center opacity-30 backdrop-blur-sm"></div>
            ...
            <div className="mt-6 flex gap-3">
              {[Remove1, Remove2, Remove3, Remove4].map((demo, i) => (
                <img
                  key={i}
                  src={demo}
                  alt={`demo-${i}`}
      ...
      {/* Stats Section */}
      <div className=" max-w-[1398px] mx-auto py-6 rounded-xl flex flex-col md:flex-row justify-center gap-8 text-center"
        style={{
