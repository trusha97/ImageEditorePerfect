...
const ImageUnblurEditer = () => {
    return (
        <div className="lg:mx-[50px] mx-0 rounded-[30px]"
            ...
            <div className="md:pt-20 pt-10 md:px-0 px-[20px]">
                ...
                <p className="font-medium text-[#2A2A33] text-base md:text-xl leading-[150%] text-center mx-auto sm:mb-[60px] mb-[30px]">
                    See the powerful results of Image Editor, from crisp details to vibrant colors, all with simple adjustments.
                </p>
...
export default ImageUnblurEditer;
