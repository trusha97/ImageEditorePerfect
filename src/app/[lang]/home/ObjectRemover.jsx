...
const ObjectRemover = () => {
  ...
  return (
    // <div className="w-full px-4 xl:px-20 2xl:px-51.5 xl:40">
    <div className="max-w-[1506px] mx-auto pt-[50px] px-4 ">
      <div className="flex flex-col xl:flex-row justify-between items-center">

        {/* ==== Right Side (Text Content) ==== */}
        <div className="relative flex items-center w-full xl:w-[738px] md:h-[440px] h-[325px] overflow-hidden mt-8 abobrom ">
          <div className="absolute z-50 md:top-0 top-16  md:left-0 sm:left-28 left-14 aaa ">
            <Image
              src={obremover}
              alt="obremover image"
        ...
        {/* ==== Left Side (Images) ==== */}
        <div className=" w-full xl:w-auto xl:text-left text-center !mx-auto xl:mb-0 mb-14.5">
          {/* <div className="xl:text-left text-center !mx-auto">
            <button
              type="button"
              className="text-[var(--orange)] bg-[var(--liteorange)] rounded-[44px] px-4 py-1.5 font-bold text-sm leading-4"
