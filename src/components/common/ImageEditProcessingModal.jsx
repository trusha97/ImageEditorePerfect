...
import { ProcessingAnimation } from "../../utils/image";

const ImageEditProcessingModal = ({ isOpen, onClose }) => {
  if (!isOpen) return null;

  return (
    <div className="fixed inset-0 z-50 flex  items-center justify-center bg-black/40 backdrop-blur-[2px]">
      <div className="relative flex-col text-center flex items-center justify-center h-[561px] w-[520px] sm:w-[620px] md:w-[720px] lg:w-[820px] xl:w-[994px] bg-white rounded-[24px] shadow-[0_4px_40px_rgba(0,0,0,0.1)] p-10   "
      >
        {/* Close button */}
        <button
          onClick={onClose}
...
export default ImageEditProcessingModal;
